...
export const skills: SkillNode[] = [
  ...
  { id: "anthropic", label: "Anthropic Claude", category: "ai-ml" },
  { id: "llamaindex", label: "LlamaIndex", category: "ai-ml" },
  { id: "langgraph", label: "LangGraph", category: "ai-ml" },
  { id: "multiagent", label: "Multi-Agent Systems", category: "ai-ml" },
  { id: "agents", label: "Agentic Workflows", category: "ai-ml" },
  { id: "embeddings", label: "Embeddings", category: "ai-ml" },
  { id: "vectorsearch", label: "Vector Search", category: "ai-ml" },
  { id: "semanticsearch", label: "Semantic Search", category: "ai-ml" },
  { id: "finetuning", label: "Fine-tuning / LoRA", category: "ai-ml" },
  { id: "transformers", label: "Transformers", category: "ai-ml" },
  { id: "vllm", label: "vLLM / Model Serving", category: "ai-ml" },
  { id: "mlops", label: "MLOps", category: "ai-ml" },
  { id: "modeleval", label: "LLM Evaluation", category: "ai-ml" },
  { id: "sentencetransformers", label: "SentenceTransformers", category: "ai-ml" },
